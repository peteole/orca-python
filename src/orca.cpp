        ...
        for (int nx1 = 0; nx1 < deg[x]; nx1++)
        {
            ...
            for (int nx2 = nx1 + 1; nx2 < deg[x]; nx2++)
            {
                ...
                for (int na = 0; na < deg[a]; na++)
                {
                    ...
                    if (c == x || adjacent(x, c) || !adjacent(b, c))
                        continue;
                    orbit[x][12]++;
            ...
            for (int nx2 = nx1 + 1; nx2 < deg[x]; nx2++)
            {
                ...
                {
                    int c = inc[x][nx3].first, xc = inc[x][nx3].second;
                    if (c == a || c == b || adjacent(a, c) || adjacent(b, c))
                        continue;
                    orbit[x][11]++;
                    f_44 += tri[xc];
                    f_33 += deg[x] - 3;
            ...
            for (int nx2 = 0; nx2 < deg[x]; nx2++)
            {
                ...
                for (int nb = 0; nb < deg[b]; nb++)
                {
                    ...
                    if (c == x || c == a || adjacent(a, c) || adjacent(x, c))
                        continue;
                    orbit[x][10]++;
                    f_52 += common_a[c] - 1;
                    f_43 += tri[bc];
            ...
            for (int na1 = 0; na1 < deg[a]; na1++)
            {
                ...
                for (int na2 = na1 + 1; na2 < deg[a]; na2++)
                {
                    ...
                    if (c == x || !adjacent(b, c) || adjacent(x, c))
                        continue;
                    orbit[x][9]++;
            ...
            for (int na = 0; na < deg[a]; na++)
            {
                ...
                {
                    int c = inc[b][nb].first, bc = inc[b][nb].second;
                    if (c == a || adjacent(a, c) || adjacent(x, c))
                        continue;
                    orbit[x][4]++;
                    f_35 += common_a[c] - 1;
                    f_34 += common_x[c];
            ...
            for (int nx2 = 0; nx2 < deg[x]; nx2++)
            {
                ...
                for (int nb = 0; nb < deg[b]; nb++)
                {
                    ...
                    if (c == x || adjacent(a, c) || adjacent(x, c))
                        continue;
                    orbit[x][5]++;
                    f_17 += deg[a] - 1;
                }
        ...
        for (int nx = 0; nx < deg[x]; nx++)
        {
            ...
            for (int nx1 = 0; nx1 < deg[x]; nx1++)
            {
                ...
                for (int nx2 = nx1 + 1; nx2 < deg[x]; nx2++)
                {
                    ...
                    if (b == y || !adjacent(y, b) || !adjacent(a, b))
                        continue;
            ...
            for (int nx = 0; nx < deg[x]; nx++)
            {
                ...
                {
                    int b = adj[x][nx1];
                    if (b == y || b == a || adjacent(y, b) || adjacent(a, b))
                        continue;
                    eorbit[e][8]++;
                }
                ...
                {
                    int b = adj[y][ny1];
                    if (b == x || b == a || adjacent(x, b) || adjacent(a, b))
                        continue;
                    eorbit[e][8]++;
                }
            }
            ...
            for (int nx = 0; nx < deg[x]; nx++)
            {
                ...
                for (int na = 0; na < deg[a]; na++)
                {
                    ...
                    if (b == x || b == y || adjacent(x, b) || adjacent(y, b))
                        continue;
                    eorbit[e][7]++;
                    f_45 += common_x[b] - 1;
                    f_45 += common_y[b] - 1;
            ...
            for (int ny = 0; ny < deg[y]; ny++)
            {
                ...
                {
                    int b = adj[a][na], ab = inc[a][na].second;
                    if (b == y || adjacent(y, b) || adjacent(x, b))
                        continue;
                    eorbit[e][2]++;
                    f_29 += common_y[b] - 1;
                    f_28 += common_x[b];
            ...
            for (int nx = 0; nx < deg[x]; nx++)
            {
                ...
                {
                    int b = adj[a][na], ab = inc[a][na].second;
                    if (b == x || adjacent(x, b) || adjacent(y, b))
                        continue;
                    eorbit[e][2]++;
                    f_29 += common_x[b] - 1;
                    f_28 += common_y[b];
                 ...
                 const char *input_filename, const char *output_filename, string &out_str)
{
    ...
    for (int i = 0; i < m; i++)
        eorbit[i] = (int64 *)calloc(68, sizeof(int64));
